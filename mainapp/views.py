...
def set_invoice_update_amount(request):
    if request.method == 'POST':
        ...
        global_var.new_invoices_num = int(invoices_num)
        global_var.new_pricing_num = int(pricing_num)
        global_var.new_correction_invoices_num = int(correction_invoices_num)
